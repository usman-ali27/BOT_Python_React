...
class GridConfig:
    ...
    basket_stop_loss_usd: float = -80.0
...
def build_grid_levels(
    ...
    # Enforce strict minimum $10 delta per user override AFTER regime scaling
    if spacing < 10.0:
        spacing = 10.0   
    ...
    for i in range(1, buy_count + 1):
        ...
        levels.append(GridLevel(
            ...
            direction="BUY",
            lot=lot,
            sl_price=0.0, # Removed per-order SL; managed by Basket SLA
